          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                disabled={!playerName.trim() || loading || !isConnected || isCreatingGame}
                className="w-full"
              >
            ...
            <CardContent className="pt-6">
              <div className="text-center text-red-700">
                ...
                <p className="text-sm">
                  ...
                  The multiplayer server should be accessible at localhost:3001.
                </p>
              </div>
            </CardContent>
          </Card>
